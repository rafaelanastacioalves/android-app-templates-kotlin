...
class ActivityBindingAdapter(val activity: Activity) {
    ...
    @BindingAdapter(value = ["imageUrl", "loadListener"], requireAll = false)
    fun bindImage(imageView: ImageView, url: String?, loadListener: Callback?){
